...
export const CropDiversity = (props) => {
  ...
  if (props.diversityList['data']length > 0{thisCountyDiversity = diversityList['data'][0][props.selectedCounty] }
    return (
        ...
        <div className="row text-center info-row">
          ...
          <div className="row">
            ...
            <br/>
            The average diversity score is {props.diversityList.average_diversity_score}
            <br/>
